...
public class CrusherGui extends GuiContainer{
	 private CrusherEntity furnaceInventory;
        public CrusherGui(InventoryPlayer player_inventory, CrusherEntity tile_entity){
                super(new ContainerCrusher(player_inventory, tile_entity));
        ...
        protected void drawGuiContainerForegroundLayer(int i, int j){
                ...
                fontRenderer.drawString("Rock Crusher", 6, 6, 0xffffff);
