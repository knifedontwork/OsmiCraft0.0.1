...
public class ImpactCrusherEntity extends TileEntity implements IInventory,
ISidedInventory {
...
if (this.rockCrusher[0] == null) {
	...
	ItemStack var1 = ImpactCrushingRecipes.crushing().getCrushingResult(this.rockCrusher[0]);
	if (var1 == null)
		return false;
