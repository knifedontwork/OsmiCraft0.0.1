...
public class BlastFurnace extends BlockContainer {
	...
	public int getBlockTexture(IBlockAccess par1IBlockAccess, int par2,
		...
		if (par5 == 1) {
			return this.blockIndexInTexture = 50;
		} else if (par5 == 0) {
			return this.blockIndexInTexture = 50;
		} else {
			int var6 = par1IBlockAccess.getBlockMetadata(par2, par3, par4);
			return par5 != var6 ? this.blockIndexInTexture
					: (this.isActive ? this.blockIndexInTexture - 2
	...
	public int getBlockTextureFromSide(int side) {
		...
		case 0:
			return this.blockIndexInTexture = 50;
		case 1:
			return blockIndexInTexture = 50;
		case 2:
			return blockIndexInTexture = 50;
		case 3:
			return blockIndexInTexture = 49;
		case 4:
			return blockIndexInTexture = 50;
		case 5:
			return blockIndexInTexture = 50;
	...
	public void breakBlock(World par1World, int par2, int par3, int par4,
		...
		if (!keepFurnaceInventory) {
			BlastFurnaceEntity var7 = (BlastFurnaceEntity) par1World
